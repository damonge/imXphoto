...
if whichfig=='fig3' or whichfig=='all':
    ...
    ax.fill_between([zrange_SKA[0],zrange_SKA[1]],[10.**(-2.1),10**(-2.1)],[1E-2,1E-2],
                           facecolor=col_SKA,alpha=0.5,edgecolor='none')
    ax.fill_between([zrange_MKT[0],zrange_MKT[1]],[10.**(-2.2),10**(-2.2)],[10.**(-2.1),10**(-2.1)],
                           facecolor=col_MKT,alpha=0.5,edgecolor='none')
    plt.xlim([0,2.7])
    plt.ylim([5E-5,1E-2])
    ax.tick_params(axis='x', labelsize=14)
...
if whichfig=='fig6' or whichfig=='all':
    ...
    ax=plt.gca()
    ax.fill_between([zrange_SKA[0],zrange_SKA[1]],[10.**(-3.9),10**(-3.9)],[10**(-4.0),10**(-4.0)],
                           facecolor=col_SKA,alpha=0.5,edgecolor='none')
    ax.fill_between([zrange_HIRAX[0],zrange_HIRAX[1]],[10.**(-3.8),10**(-3.8)],[10.**(-3.9),10**(-3.9)],
                           facecolor=col_HIRAX,alpha=0.5,edgecolor='none')
    ax.fill_between([zrange_MKT[0],zrange_MKT[1]],[10.**(-3.7),10**(-3.7)],[10.**(-3.8),10**(-3.8)],
                           facecolor=col_MKT,alpha=0.5,edgecolor='none')
    plt.xlim([0,2.7])
    plt.ylim([1E-4,3E-2])
    plt.yscale('log')
